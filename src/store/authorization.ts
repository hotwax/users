...
export const useAuthorizationStore = defineStore('authorization', {
  ...
  actions: {
    ...
    async addUserGroupPermission(payload: { userGroupId: string; userPermissionId: string; fromDate: number }): Promise<any> {
      return api({
    ...
    async removeUserGroupPermission(payload: { userGroupId: string; userPermissionId: string; fromDate: number; thruDate: number }): Promise<any> {
    ...
    async createArtifactAuthz(payload: { userGroupId: string; artifactGroupId: string; authzTypeEnumId: string; authzActionEnumId: string; authzServiceName?: string }): Promise<any> {
      return api({
    ...
    async updateArtifactAuthz(payload: { userGroupId: string; artifactAuthzId: string; artifactGroupId: string; authzTypeEnumId: string; authzActionEnumId: string; authzServiceName?: string }): Promise<any> {
      return api({
    ...
    async deleteArtifactAuthz(payload: { userGroupId: string; artifactAuthzId: string }): Promise<any> {
      return api({
        url: `admin/userGroups/${payload.userGroupId}/artifactAuthorizations/${payload.artifactAuthzId}`,
        method: "delete"
      });
