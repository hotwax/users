<template>
  ...
  <ion-content>
    <form @keyup.enter="save()">
      <ion-item lines="full">
        <ion-select :label="translate('Artifact group')" interface="popover" v-model="form.artifactGroupId" :disabled="isEditMode">
      ...
      <ion-item lines="full">
        <ion-select :label="translate('Authz type')" interface="popover" v-model="form.authzTypeEnumId">
      ...
      <ion-item lines="full">
        <ion-select :label="translate('Action')" interface="popover" v-model="form.authzActionEnumId">
      ...
      <ion-item lines="none">
        <ion-input :label="translate('Authz service name')" placeholder="co.hotwax.SomeServices.some#Service" v-model="form.authzServiceName" />
      </ion-item>
    </form>
  </ion-content>
