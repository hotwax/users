<template>
  <ion-content>
    <ion-list>
      ...
      <ion-item @click="updateContactField()" button :disabled="!userStore.hasPermission('PARTYMGR_PCM_UPDATE OR PARTYMGR_UPDATE OR PARTYMGR_ADMIN')">
        {{ translate("Edit") }}
      </ion-item>
      <ion-item @click="deleteContactField()" button lines="none" :disabled="!userStore.hasPermission('PARTYMGR_PCM_DELETE OR PARTYMGR_ADMIN')">
        {{ translate("Remove") }}
      </ion-item>
    </ion-list>
  </ion-content>
