<template>
  ...
  <ion-content>
    <form @keyup.enter="updateUserGroup()">
      <ion-item lines="none">
        <ion-textarea :label="translate('Description')" :counter="true" :maxlength="255" :auto-grow="true" v-model="description" />
      </ion-item>
    </form>
  </ion-content>

  <ion-fab vertical="bottom" horizontal="end" slot="fixed">
    <ion-fab-button @click="updateUserGroup()" :disabled="description === (userGroup.description || '')">
