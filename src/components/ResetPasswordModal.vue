  ...
  <ion-content>
    <ion-list>
      ...
      <ion-item lines="full" ref="password">
        <!-- <ion-label position="fixed">{{ translate("New password") }}</ion-label> -->
        <ion-input label="New password" label-placement="fixed" @keyup="validatePassword" @ionBlur="markPasswordTouched" :placeholder="translate('Enter password')" name="password" v-model="newPassword" id="newPassword" :type="showNewPassword ? 'text' : 'password'" required />
      ...
      <ion-item ref="confirmPassword">
        <!-- <ion-label position="fixed">{{ translate("Verify password") }}</ion-label> -->
        <ion-input label="New password" label-placement="fixed" @keyup="validateConfirmPassword()" @ionBlur="markConfirmPasswordTouched" :placeholder="translate('Confirm password')" name="confirmPassword" v-model="confirmPassword" id="confirmPassword" :type="showConfirmPassword ? 'text' : 'password'" required />
